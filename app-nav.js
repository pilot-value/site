/* ══════════════════════════════════════════════════════════════════════════
   ...
   ★2026-09-07、**ログイン・新規登録・給与フォーム（日英6枚）にも入れた**（オーナー指示）。
     除いていた間、その6枚だけ旧 search.js の右の引き出しがそのまま残り、
     広い画面ではレールが消えて ≡ だけが出ていた＝ナビが2種類あった。
   入れないのは、ヘッダーを持たない画面（auth-callback / 404 / admin /
   unsubscribe / my-value）だけ ── 繋ぎ直す ≡ も、開く板も無い。
