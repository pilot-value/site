...
const APPFLOW = new Set([
  ...
  /* ★2026-09-06、my-value.html は MY PAGE への転送1枚になったので外した。
     ログインの見張りは送り先の profile.html が持っている。 */
  'profile.html', 'actual-pay.html', 'deep-pay.html', 'deep-pay-compare.html', 'pay-report.html', 'submit-review.html', 'unsubscribe.html',
]);
