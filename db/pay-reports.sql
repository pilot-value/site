...
alter table public.pay_reports
  ...
  -- ★ 2026-08-26 追加。審査・査察の手当（Examiner / Check）。
  --    教官の手当（instructor_pay）とも**別の列**に持つ。
  --    まとめて払われている人はこちらを空にして instructor_pay 側だけに入れる
...
-- ★審査の手当も同じ扱い。基本給2万＋審査4万 → 12×60,000 = 720,000
select public.pv_annual_total(null, 20000, null, null, null, null, null, null,
                              null, null, null, null, null, null, null, null, 40000) as 期待720000;
...
--         **伏せた行**（会社・出典・投稿時期の3つだけ）を返すため anon に開けた。
--         ⚠️ 外したのはこの1本だけ。何が返るかは db/pay-rows.sql の自己点検65
--         （伏せた行に渡すのは3つだけ）と66（PUBLIC に残っていない）が別に見ている。
