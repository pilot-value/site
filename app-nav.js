/* ══════════════════════════════════════════════════════════════════════════
   ...
   ★≡ の生まれ方は2通り。**読み込みの順番に頼らない**（並べ替え事故で静かに壊れる）。
       ...
       読まないページ           → 自分で作る
     見分けは `<script src="…search.js">` が在るかどうか。アプリ16枚も
...
(function () {
  ...
  /* ヘッダーの CTA を、引き出しを畳む前に板へ移す ───────────────────
     ...
     ★★既定は hidden。板は「408枚どこでも同じ7項目」でなければならないので、
