...
(function (w, d) {
  ...
  var T = {
    ja: {
      ...
      lockPC: '給与の内訳を入力する',
      /* 昇格後年数の段。★年そのものは持っていない（サーバが 0〜4 の段だけを返す）。
      ...
      ten: ['昇格後5年未満', '昇格後5〜10年', '昇格後10〜15年',
            '昇格後15〜20年', '昇格後20年以上'],
    ...
    en: {
      ...
      ten: ['Under 5 yrs in rank', '5–10 yrs in rank', '10–15 yrs in rank',
